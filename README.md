...
- Kanal və ya Qrup Səsli Çatlarda Radio/Musiqi Oynamaq üçün Telegram Botu.
- Youtube və Deezer dəstəyi ilə səsli söhbətlərdə səs oxutmaq üçün Telegram Botu.
- YouTube-dan canlı yayımı dəstəkləyir.

---

## QEYD:

- Yerləşdirmədən əvvəl Qrupunuzda Səsli Söhbətə başladığınıza əmin olun.
...
- Pleylist, növbə
- Səsli Çat başlığını cari oxunan mahnı adına dəyişin.
- Youtube-dan canlı yayımı dəstəkləyir
- Mahnıları axtarmaq üçün həm deezer, həm də youtube-u dəstəkləyir.
- Telegram faylından oynayın.
- Pleylistdə mahnı yoxdursa, Radionu işə salır.
- Səssiz ifanı təmin etmək üçün pleylistdəki ilk iki trek üçün audionu avtomatik yükləyir
- Heroku yenidən başlasa belə avtomatik yenidən başladın.
...
<p>
<br>
<a href="https://heroku.com/deploy?template=https://github.com/Aliyevdii/Music-Nexus-mehdi">
...
```sh
git clone https://github.com/Aliyevdii/Music-Nexus-mehdi
cd MusicPlayer
